  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (isSignedIn) {
        ...
        navigate('/signup', { state: { email: usernameOrEmail, step: 'confirm' } })
      }
    } catch (err: any) {
        ...
        <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl">
          <div className="text-center mb-10">
            <Link to="/" className="inline-block">
              <span className="text-xl font-black tracking-tighter bg-linear-to-r from-blue-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent">
                GSEP
              </span>
            </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              <label htmlFor="usernameOrEmail" className="text-xs font-semibold text-white/50 uppercase tracking-widest pl-1">
                Username or Email
              </label>
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-xl border border-white/10 bg-white/5 pl-4 pr-12 py-3.5 text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all shadow-inner"
                />
                <button
                  type="button"
